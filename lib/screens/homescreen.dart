...
import 'package:phedtanker/screens/booking.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  fetchAlbum() async {
    final response = await http
        .get(Uri.parse('https://water.cloudcoderstudio.com/api/driver_booking_list.php?driver_id=${driver_id}'));
  ...
  AcceptApi(index) async {
    var response = await Dio().get('https://water.cloudcoderstudio.com/api/driver_accept.php?tid=${trip_id}');
    print(response);
